...
var FocusElement = /** @class */ (function () {
    ...
    FocusElement.prototype.doFocusElement = function (id) {
        var el = navigationService.getFocusElementById(id);
        if (el)
            el.focus();
    };
    ...
    install: function (Vue, options) {
        ...
        Vue.directive("focus", {
            ...
            unbind: function (el, binding, vnode) {
                if (vnode.elm) {
                    var focusElement = navigationService.getFocusElementById(vnode.elm.id);
                    if (focusElement)
                        navigationService.deRegisterFocusElement(focusElement);
                }
            }
        });
    }
